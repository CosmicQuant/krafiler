...
async function generateMasterTemplate() {
    ...
    // Format the header row (Bold, dark background) - Now row 5
    ...
    // 2. Add Dropdowns, Number Formatting, and Formulas for 500 rows (starting from Row 6)
    for (let i = 6; i <= 505; i++) {
    ...
    // 3. Save the file
    const fileName = 'Axon_Unified_Payroll_Template_v4.xlsx';
    await workbook.xlsx.writeFile(fileName);
    console.log(`✅ Success! Generated ${fileName} with strict dropdown menus and live Excel Auto-Calculations.`);
}
